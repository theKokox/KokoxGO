...
# parser.add_argument('-lat', '--latitude' , type=float, help='Intial Location latitude' , required=True)
# parser.add_argument('-lng', '--longitude', type=float, help='Intial Location longitude', required=True)
# parser.add_argument('-r'  , '--radius'   , type=int  , help='Radius (km) to cover'     , required=True)
